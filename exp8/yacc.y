...
Stmt : AssigStmt Stmt| IfStmt Stmt
     |
     ;
...
CondStmt : NOT CondStmt | OrStmt
		 ;

OrStmt : OrStmt OR CondStmt | AndStmt
	   ;

AndStmt : AndStmt AND CondStmt | Cond
		;
